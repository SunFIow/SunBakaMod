...
package com.sunflow.sunbakamod.launcher;
...
public class MyCustomLauncher {
	...
	public static void main(String... args) throws InterruptedException {
		...
		Arrays.stream(markerselection.split(",")).forEach(
				marker -> System.setProperty("forge.logging.marker." + marker.toLowerCase(Locale.ROOT), "ACCEPT"));
